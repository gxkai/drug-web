    ...
    <div class="recommend-wrap">
      ...
      <el-form ref="form" :model="recommendForm" label-width="100px" class="recommend-form">
        ...
        <el-form-item label="活动价格：">
          <el-input readonly v-model="recommendForm.price" size="small" style="width: 400px"></el-input>
        </el-form-item>
        <el-form-item label="活动数量：">
          <el-input readonly v-model="recommendForm.number" size="small" style="width: 400px"></el-input>
        </el-form-item>
        <el-form-item>
...
<script>
  ...
  export default class RecommendDetail extends Vue {
    ...
    async getRecommendDetail () {
      ...
      // let shopDrugId = this.$route.query.shopDrugId
      // let resDetail = await axios.get(`/api/shop/ShopDrugAdminDTO/${shopDrugId}`)
