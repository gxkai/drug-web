<template>
  <div>
      ...
      <template slot="center">
        <van-pull-refresh v-model="isLoading" @refresh="onRefresh">
          <van-list
            ...
            <div
              v-for="item in list"
              @click="loadPageDrugsShops(item.id)"
            >
              <new-white-space/>
    ...
    <van-popup v-model="show" position="right" class="popup-wrapper">
      <new-white-space/>
      <info-cell title="商品名称" :desc="namesFilter" is-link  @click.native="showName = true;"/>
      <info-cell title="厂家" :desc="originsFilter" is-link  @click.native="showOrigin = true;"/>
      <info-cell title="规格" :desc="specsFilter" is-link  @click.native="showSpec = true;"/>
      <info-cell title="剂型" :desc="formsFilter" is-link  @click.native="showForm = true;"/>
