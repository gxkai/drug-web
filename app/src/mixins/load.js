export default {
  methods: {
    ...
    loadPageInsurancesConsumeInfoMore(consumeInfoMore) {
      this.loadPage_p('/insurances/consumeInfoMore', {consumeInfoMore: consumeInfoMore});
    },
    loadPageLogin() {
      this.loadPage('/login');
    },
    ...
    loadPageOrdersCreateFromCart(cartShop, isRx) {
      this.loadPage_p('/orders/create/fromCart', {cartShop: cartShop, isRx: isRx});
    },
    loadPageOrdersCreateFromShop(shopDrugOrderDTO) {
      this.loadPage_p('/orders/create/fromShop', {shopDrugOrderDTO: shopDrugOrderDTO});
    },
    loadPageRepositories(title, repositoryTypeId) {
      this.loadPage('/repositories', {title: title, repositoryTypeId: repositoryTypeId});
    },
    ...
    loadPageRxsShopsDrugs(rxId, item) {
      this.loadPage('/rxs/shops/drugs', {rxId: rxId, shopId: item.id, shopName: item.name, type: item.type});
    },
