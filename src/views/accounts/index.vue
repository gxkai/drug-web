...
<style scoped>
  ...
  /*.f_account_center_header img {*/
    /*width: 4rem;*/
    /*height: 4rem;*/
    /*border-radius: 50%;*/
  /*}*/

  /*.f_account_center_header > span {*/
    /*display: block;*/
  /*}*/

  /*.f_account_center_order .icon {*/
    /*font-size: 2.5rem;*/
    /*position: relative;*/
  /*}*/

  /*.f_account_center_orders {*/
    /*width: 100%;*/
    /*display: flex;*/
    /*flex-direction: row;*/
  ...
  /*.f_account_center_orders :last-child {*/
    /*font-size: 1rem;*/
    /*color: #a5a5a5;*/
  /*}*/
  ...
  /*}*/
  /*.f_account_center_menu_listd:nth-child(4n){*/
    /*border-right: none;*/
  /*}*/

  /*.f_account_center_menu_list img {*/
    /*width: 2rem;*/
    /*height: 2rem;*/
  /*}*/

  /*.f_account_center_menu_list span {*/
    /*display: block;*/
    /*font-size: 1rem;*/
    /*margin-top: 0.5rem;*/
  /*}*/
