    ...
    <template slot="center">
      <van-list
        ...
        >
          <div class="pharmacist__item__first">
            ...
            <div class="pharmacist__item__first__right">
              <div class="pharmacist__item__first__right__first">
                ...
                <span class="pharmacist__item__first__right__first__tag">全家康药师客服中心</span>
              </div>
          ...
          <div class="pharmacist__item__second">
            <span class="pharmacist__item__second__item">多年经验</span>
            <span class="pharmacist__item__second__item">耐心温柔</span>
            <span class="pharmacist__item__second__item">专业知识扎实</span>
          </div>
          <div class="pharmacist__item__third">
            <span class="pharmacist__item__third__button"
            @click="$router.push({path:'/pharmacists/chat', query: {user: JSON.stringify(item)}})"
            >咨询药师</span>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      async onLoad() {
        ...
        const data = await this.$http.get('/admin-pharmacist', params);
